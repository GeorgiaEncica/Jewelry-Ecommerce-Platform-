...
<div class="products-container" id="products-container">
    <div class="loading-overlay"><i class="fas fa-spinner"></i><p>Loading Rings...</p></div>
</div>
...
<footer class="site-footer">
    <div class="footer-container">
        ...
        <div class="footer-section">
            ...
            <p><strong>Address:</strong> Jewelry Strret 13, London, UK</p>
...
function loadProducts() {
    productsContainer.innerHTML = '<div class="loading-overlay"><i class="fas fa-spinner"></i><p>Loading Rings...</p></div>';
    ...
    fetch(url)
        ...
        .then(data => {
            if (data.success) {
                ...
                resultsInfo.innerHTML = `Showing ${data.count} ring${data.count !== 1 ? 's' : ''}`;
            }
        })
        .catch(err => {
            console.error(err);
...
function displayProducts(products) {
    if (!products.length) {
        productsContainer.innerHTML = '<p style="text-align:center;color:#999;">No rings found.</p>';
        return;
    }
